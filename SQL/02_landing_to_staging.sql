...
---------- parsing CSV/XML/JSON files into the tables ----------
-- O que é o parser:
-- É um script Python (ou um pequeno serviço) que roda sob agendamento (ou chamado pelo Data Factory) e faz:
-- Para cada arquivo:
-- baixa/lê o arquivo do Data Lake (landing)
-- identifica o formato (CSV/XML/JSON) pelo sufixo
-- converte cada registro do arquivo em um dicionário padronizado
-- insere na tabela stg_*
-- atualiza landing_file.status
